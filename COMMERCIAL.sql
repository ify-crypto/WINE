...
INSERT INTO CUSTOMERS VALUES ('ANATR', 'Ana Trujillo Emparedados y helados', 'Avda. de la Constitución 2222', 'México D.F.', '05021', 'Mexico', '(5) 555-4729', '(5) 555-3745');

INSERT INTO CUSTOMERS VALUES ('ANTON', 'Antonio Moreno Taquería', 'Mataderos 2312', 'México D.F.', '05023', 'Mexico', '(5) 555-3932', '');

INSERT INTO CUSTOMERS VALUES ('AROUT', 'Around the Horn', '120 Hanover Sq.', 'London', 'WA1 4SD', 'United Kingdom', '(71) 555-7788', '(71) 555-6750');

INSERT INTO CUSTOMERS VALUES ('BERGS', 'Berglunds snabbköp', 'Berguvsvägen 8', 'Luleå', 'S-958 22', 'Sweden', '0921-12 34 65', '0921-12 34 67');
...
INSERT INTO CUSTOMERS VALUES ('BOLID', 'Bólido Comidas preparadas', 'Araquil, 67', 'Madrid', '28023', 'Spain', '(91) 555 22 82', '(91) 555 91 99');

INSERT INTO CUSTOMERS VALUES ('BONAP', 'Bon app''étit', '12, rue des Bouchers', 'Marseille', '13008', 'France', '04.91.24.45.40', '04.91.24.45.41');
...
INSERT INTO CUSTOMERS VALUES ('CENTC', 'Centro comercial Moctezuma', 'Sierras de Granada 9993', 'México D.F.', '05022', 'Mexico', '(5) 555-3392', '(5) 555-7293');

INSERT INTO CUSTOMERS VALUES ('CHOPS', 'Chop-suey Chinese', 'Hauptstr. 29', 'Bern', '3012', 'Switzerland', '0452-076545', '');


INSERT INTO CUSTOMERS VALUES ('COMMI', 'Comércio Mineiro', 'Av. dos Lusíadas, 23', 'São Paulo', '05432-043', 'Brazil', '(11) 555-7647', '');
...
INSERT INTO CUSTOMERS VALUES ('FAMIA', 'Familia Arquibaldo', 'Rua Orós, 92', 'São Paulo', '05442-030', 'Brazil', '(11) 555-9857', '');
...
INSERT INTO CUSTOMERS VALUES ('FOLKO', 'Folk och fä HB', 'Åkergatan 24', 'Bräcke', 'S-844 67', 'Sweden', '0695-34 67 21', '');

INSERT INTO CUSTOMERS VALUES ('FRANK', 'Frankenversand', 'Berliner Platz 43', 'München', '80805', 'Germany', '089-0877310', '089-0877451');
...
INSERT INTO CUSTOMERS VALUES ('GALED', 'Galería del gastrónomo', 'Rambla de Cataluña, 23', 'Barcelona', '08022', 'Spain', '(93) 203 4560', '(93) 203 4561');

INSERT INTO CUSTOMERS VALUES ('GODOS', 'Godos Cocina Típica', 'Romero, 33', 'Sevilla', '41101', 'Spain', '(95) 555 82 82', '');
...
INSERT INTO CUSTOMERS VALUES ('HANAR', 'Hanari Carnes', 'Rua do Paço, 67', 'Rio de Janeiro', '05454-876', 'Brazil', '(21) 555-0091', '(21) 555-8765');
...
INSERT INTO CUSTOMERS VALUES ('KOENE', 'Königlich Essen', 'Maubelstr. 90', 'Brandenburg', '14776', 'Germany', '0555-09876', '');
...
--Display in descending order of seniority the male employees whose net salary (salary + commission) is 
--greater than or equal to 8000. The resulting table should include the following columns: Employee Number, 
--First Name and Last Name (using LPAD or RPAD for formatting), 
--Age, and Seniority.

SELECT*FROM [dbo].[EMPLOYEES]

 SELECT EMPLOYEE_NUMBER,LAST_NAME,FIRST_NAME,SALARY,
 (2024- (year(BIRTH_DATE))) AS Current_Age,(2024- (year(HIRE_DATE))) AS Seniority
 FROM[dbo].[EMPLOYEES]
 where salary >= 8000 and TITLE IN ('Mr.','Dr.')
 ORDER BY Seniority DESC

 --Display products that meet the following criteria: (C1) quantity is packaged in bottle(s), (C2) the third character
 -- in the product name is 't' or 'T', (C3),supplied by suppliers 1, 2, or 3, (C4) unit price ranges between 70 and 200, 
 -- and (C5) units ordered are specified (not null). The resulting table should
 -- include the following columns: product number, product name, supplier number, units ordered, and unit price.

 SELECT*FROM [dbo].[PRODUCTS] 

 SELECT PRODUCT_REF, PRODUCT_NAME, SUPPLIER_NUMBER, UNITS_ON_ORDER, UNIT_PRICE,UNITS_IN_STOCK
 FROM [dbo].[PRODUCTS]
 WHERE QUANTITY = 'bottles' and SUPPLIER_NUMBER BETWEEN 1AND 3
 AND UNIT_PRICE BETWEEN 70 AND 200
 AND UNITS_IN_STOCK IS NOT NULL 
AND PRODUCT_NAME LIKE ' --t% '


-- Display customers who reside in the same region as supplier 1, meaning they share the same country, 
-- city, and the last three digits of the postalcode. 
...
SELECT * FROM [dbo].[CUSTOMERS] CUSTOMERS
  RIGHT JOIN (SELECT City, Country, Postal_code FROM [dbo].[SUPPLIERS] 
WHERE SUPPLIER_NUMBER =1) AS Supplier_Location on Customers.CITY = Supplier_Location.CITY
AND CUSTOMERS.POSTAL_CODE = Supplier_Location.POSTAL_CODE;
...
-- is between 0 and 2000, 5% if between 2001 and 10000, 10% if between 10001 and 40000,
...
SELECT ORDER_NUMBER,
   ...
   WHEN UNIT_PRICE * QUANTITY BETWEEN 10000 AND 10999  THEN '10%' 
   WHEN UNIT_PRICE * QUANTITY BETWEEN 40001 AND 80000  THEN '15%'
   ELSE '20%'
   END AS NEW_DISCOUNT_RATE,
    CASE
	WHEN UNIT_PRICE * QUANTITY BETWEEN 10000 AND 10999 THEN 'OLD _DISCOUNT_RATE'
	ELSE 'NEW_DISOUNT_RATE'
   END AS NEW_DISCOUNT_RATE
...
SELECT PR.SUPPLIER_NUMBER,SU.COMPANY,SU.ADDRESS,SU.PHONE
FROM[dbo].[PRODUCTS] PR
LEFT JOIN [dbo].[SUPPLIERS]SU
ON PR.SUPPLIER_NUMBER = SU.SUPPLIER_NUMBER
LEFT JOIN [dbo].[CATEGORIES]CA
ON CA.CATEGORY_CODE = PR.CATEGORY_CODE
WHERE CA.CATEGORY_NAME = 'Beverages'; 
...
SELECT CU.CUSTOMER_CODE,count(OD.ORDER_NUMBER) AS N0_OF_CUST
FROM[dbo].[CUSTOMERS]CU
LEFT JOIN [dbo].[ORDERS]OD
ON CU.CUSTOMER_CODE = OD.CUSTOMER_CODE
LEFT JOIN [dbo].[ORDER_DETAILS]ORD
ON ORD.ORDER_NUMBER = OD.ORDER_NUMBER
LEFT JOIN [dbo].[PRODUCTS]PR
ON ORD.PRODUCT_REF = PR.PRODUCT_REF
left JOIN[dbo].[CATEGORIES]C
ON PR.CATEGORY_CODE = C.CATEGORY_CODE 
WHERE Cu.CITY = 'Berlin' AND C.CATEGORY_NAME ='DESSERTS'
AND PR.UNITS_ON_ORDER BETWEEN 0 AND 1
...
--   (considering customers who haven't placed any orders yet). The resulting table should
-- display the columns: customer number, company name, phone number, total amount, and country
...
SELECT CU.CUSTOMER_CODE,CU.COMPANY,CU.PHONE,SUM (ORD.UNIT_PRICE* ORD.QUANTITY) AS TOTAL_ORDER,CU.COUNTRY
FROM.[dbo].[CUSTOMERS]CU
 LEFT JOIN [dbo].[ORDERS]OD 
ON OD.CUSTOMER_CODE = CU.CUSTOMER_CODE
LEFT JOIN [dbo].[ORDER_DETAILS]ORD
ON OD.ORDER_NUMBER = ORD.ORDER_NUMBER
WHERE CU.COUNTRY = 'France'
and YEAR(OD.ORDER_DATE) = '1998'
AND MONTH(OD.ORDER_DATE) = '04'
AND DATEPART(WEEKDAY,OD.ORDER_DATE) = '2'
GROUP BY CU.CUSTOMER_CODE,CU.COMPANY,CU.PHONE,CU.COUNTRY
...
SELECT DISTINCT O.CUSTOMER_CODE, C.COMPANY, C.PHONE
...
-- The resulting table should display the columns: customer code 
...
SELECT CU.CUSTOMER_CODE,COUNT(OD.ORDER_NUMBER) AS NO_OF_ORDERS
FROM[dbo].[CUSTOMERS] CU
RIGHT JOIN [dbo].[ORDERS]OD
ON OD.CUSTOMER_CODE = CU.CUSTOMER_CODE
WHERE CU.COUNTRY = 'France'
GROUP BY  CU.CUSTOMER_CODE
ORDER BY COUNT(OD.ORDER_NUMBER)
...
--The resulting table should display the columns: orders in 1996, orders in 1997, and Differ
